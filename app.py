...
# =====================================================
# GLOBAL CSS (Compact Professional Layout)
# =====================================================
    ...
    try:
        ...
        <div class="prediction-box">
            <div class="prediction-row">
                ...
                <div class="prediction-item">
                    ...
                    <div class="prediction-value">{lr_decision['credit_score']}</div>
                </div>
                <div class="prediction-item">
        ...
        <div class="prediction-box">
            <div class="prediction-row">
                ...
                <div class="prediction-item">
                    <div class="prediction-title">Credit Score</div>
                    <div class="prediction-value">{xgb_decision['credit_score']}</div>
                </div>
                <div class="prediction-item">
                    <div class="prediction-title">Rating Band</div>
        ...
        lr_display = pd.DataFrame({
            ...
            "Raw Value": [validated_raw.get(f, None) for f in lr_vector.columns],
...
#         # =====================================================
#         # VERTICAL INPUT TABLES (Feature | Raw | Model Ready)
#         # =====================================================
...
#         with col1:
#             st.markdown("### 📘 LR Model Input Vector")
#             lr_display = pd.DataFrame({
#                 "Feature": lr_vector.columns,
#                 "Raw Input": [validated_raw[f] for f in lr_vector.columns],
#                 "WOE Transformed": lr_vector.iloc[0].values
#             })
#             st.dataframe(lr_display, use_container_width=True)

#         with col2:
#             st.markdown("### 📗 XGB Model Input Vector")
#             xgb_display = pd.DataFrame({
#                 "Feature": xgb_vector.columns,
#                 "Raw Input": [validated_raw.get(f, None) for f in xgb_vector.columns],
#                 "Model Ready Value": xgb_vector.iloc[0].values
#             })
#             st.dataframe(xgb_display, use_container_width=True)
